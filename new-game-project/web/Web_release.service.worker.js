...
/** @type {string} */
const OFFLINE_URL = 'Web_release.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = false;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Web_release.html","Web_release.js","Web_release.offline.html","Web_release.icon.png","Web_release.apple-touch-icon.png","Web_release.audio.worklet.js","Web_release.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Web_release.wasm","Web_release.pck"];
